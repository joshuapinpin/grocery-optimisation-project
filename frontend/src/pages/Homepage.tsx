      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Easily search and compare grocery prices across multiple stores in
              your area
            </p>
          </div>
          <div className="feature-card">
          ...
          <div className="feature-card">
            <div className="feature-icon">📍</div>
            <h3>Store Locator</h3>
            <p>Choose nearby stores and get a personalised shopping route planned</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">⭐</div>
            <h3>Reviews & Ratings</h3>
            <p>We are rated higher than every other grocery shopping app</p>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>Your one-stop destination for finding the best grocery deals</p>
          </div>
          <div className="footer-section">
            <h4>Quick Links</h4>
            <ul>
